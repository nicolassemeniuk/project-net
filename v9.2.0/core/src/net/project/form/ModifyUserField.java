...
public class ModifyUserField extends MetaDataUserField {
	
	/**
	 * @param form the Form that this field belongs to.
	 * @param field_id the id of the field in the database.
	 */
	public ModifyUserField(Form form, String field_id) {
		super(form, field_id);
    ...
    protected String getSQLSelectColumn() {
        return m_form.m_master_table_name + ".modify_person_id ";
    }    
