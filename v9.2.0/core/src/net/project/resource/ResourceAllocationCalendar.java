 ...
 * information about how much a user is allocated to tasks each day.
 ...
 * @since Version 7.6.3
 */
public class ResourceAllocationCalendar implements IXMLPersistence {
    /**
     ...
     */
    public ResourceAllocationCalendar() {
     ...
     */
    void loadAllocations(String personID) throws PersistenceException {
        ...
        ral.loadResourceAllocationsForPerson(personID);
        ...
        while(currentDate.before(lastDate) || (currentMonth == currentDate.getMonth() && currentDate.getDate() == lastDate.getDate()) ) {
            ...
            //Iterate the current date for the next iter of the while loop
            currentDate = DateUtils.addDay(currentDate, 1);
        }
     ...
     *
     * @param personID a <code>String</code> containing the person id of the
    ...
    public String getXMLBody() {
        ...
        xml.append("<ResourceAllocationCalendar>");
