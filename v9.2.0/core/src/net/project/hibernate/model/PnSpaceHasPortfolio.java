...
/**
 * PnSpaceHasPortfolio generated by hbm2java
 */
@Entity
@Table(name="PN_SPACE_HAS_PORTFOLIO"
)
public class PnSpaceHasPortfolio implements Serializable {


     private PnSpaceHasPortfolioPK comp_id;
    ...
    public PnSpaceHasPortfolio(PnSpaceHasPortfolioPK comp_id, int isDefault) {
        this.comp_id = comp_id;
        this.isDefault = isDefault;
    }

    public PnSpaceHasPortfolio(PnSpaceHasPortfolioPK comp_id, int isDefault, PnPortfolio pnPortfolio) {
       this.comp_id = comp_id;
       this.isDefault = isDefault;
    ...
    public PnSpaceHasPortfolioPK getComp_id() {
        return this.comp_id;
    }
    
    public void setComp_id(PnSpaceHasPortfolioPK comp_id) {
        this.comp_id = comp_id;
    }
