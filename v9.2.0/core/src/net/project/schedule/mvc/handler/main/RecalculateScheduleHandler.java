...
/**
 * This handler allows the user to recalculate the start date, end date,
 * duration, and assignments for every task in the schedule.  Usually the user
 * shouldn't need to do this.  The functionality is provided "just in case".
 *
 * @author Matthew Flower
 * @since Version 7.6.3
 */
public class RecalculateScheduleHandler extends MainProcessingHandler {
    public RecalculateScheduleHandler(HttpServletRequest request) {
        super(request);
    }
