...
/**
  ...
  * Envelopes
  */
public class EnvelopeVersionObjectList extends ArrayList
    ...
    private String getXMLElements() {
        ...
        for (int i=0; i < size(); i++) {
            xml.append( ((EnvelopeVersionObject) get(i)).getXMLBody() );
        }
        return xml.toString();
    }
    ...
    /**
      * Return the EnvelopeVersionObjectList XML including the XML version tag
    ...
    /**
      * Return the EnvelopeVersionObjectList XML without the XML version tag
      * @return XML string
      */
    public java.lang.String getXMLBody() {
        StringBuffer xml = new StringBuffer();
        xml.append("<envelope_version_obect_list>\n");
