...
|    $RCSfile$
|   $Revision: 16867 $
|       $Date: 2008-02-06 14:43:46 +0100 (Wed, 06 Feb 2008) $
|
|--------------------------------------------------------------------%>
<%@ page 
...
<tb:toolbar style="tooltitle" showAll="true" groupTitle="prm.global.tool.directory.name">
...
<form action="<%=SessionManager.getJSPRootURL()%>/roster/MemberWizardController.htm"  method="post">
...
<tr class="channelHeader">
	...
	<td  nowrap  class="channelHeader" colspan="3" width="98%"><nobr><display:get name="prm.directory.invite.memberaddition.channel.inviteparticipant.title" /><DISPLAY PROPERTY="request:method"/></nobr></td>
...
<tr>
    ...
    <%-- Spacer Column --%>    
<security:verifyAccess action="create"   module="<%=net.project.base.Module.DIRECTORY%>" /> 
					    ...
					    <tr align="left"> 
					        ...
					        <td colspan="3" class="tableContent"> 
						        <spring:bind path="command.firstName">
						            <input type="text" name="firstName" size="20" maxlength="80" value='<c:out value="${lastInvitee.firstName}" />'>
						        </spring:bind>
					        </td>
					        <td nowrap>&nbsp;</td>
					    </tr>
					    <tr align="left"> 
					        ...
					        <td colspan="3" class="tableContent"> 
						        <spring:bind path="command.lastName">
						            <input type="text" name="lastName" size="20" maxlength="80" value='<c:out value="${lastInvitee.lastName}" />'>
						        </spring:bind>
					        </td>
					        <td nowrap>&nbsp;</td>
					    </tr>
					    <tr align="left" > 
					        ...
					        <td colspan="3" class="tableContent"> 
					        	<spring:bind path="command.email">
					            	<input type="text" name="email" size="20" maxlength="80" value='<c:out value="${lastInvitee.email}" />'>
					            </spring:bind>
					            &nbsp;&nbsp;
					            <input type="submit" id="_target1" name="_target1" value="Next"/>
...
<tr>
    <td colspan="5">
    	<!-- tiles:insert name="currentInvites"/ -->
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr class="tableHeader">
				<td class="tableHeader">&nbsp;</td>
				<td class="tableHeader" align="left"><display:get name="prm.directory.invite.currentinvitees.column.name"/></td>
				<td class="tableHeader" align="left"><display:get name="prm.directory.invite.currentinvitees.column.emailaddress"/></td>
			</tr>
			<tr class="tableLine">
					...
					<c:forEach var="e" items='${model}'>
						<tr>
					        <td class="tableContent">
								<a href="javascript:removeInvitee('<c:out value="${e.email}"/>')">
								 	<display:get name="prm.directory.invite.currentinvitees.remove.link"/>
								</a>
					          <!--  <a href="javascript:removeInvitee();">Remove</a> -->
					        </td>
					    	<td class="tableContent">
								<c:out value="${e.lastName}"/>, <c:out value="${e.firstName}"/>
					        </td>
					        <td class="tableContent">
					            <c:out value="${e.email}"/>
					        </td>
				...
				<c:otherwise>
					<tr>
						<td class="tableContent" colspan="3">
							<display:get name="prm.directory.invite.currentinvitees.noinvitees.message"/>
						</td>
					</tr>			
				</c:otherwise>					
			</c:choose>  			
