...
<%!
// CONSTANTS
public static final String          STYLE_SHEET         = "/calendar/xsl/type-list-daily.xsl";
...
// Configure the calendar
	...
	calendar.setStartDate(calendar.startOfDay(date));
	calendar.setEndDate(calendar.endOfDay(date));
...
<table  border="0" cellpadding="0" cellspacing="0" width="100%">	
	<tr class="channelHeader">
		...
		<td width="19%" align="center"> <A HREF="<%= includer %><%= calendar.getStateAsQueryString(calendar.getPrevDay()) %>&module=<%= net.project.base.Module.CALENDAR %>"><img src="<%= SessionManager.getJSPRootURL() %>/images/icons/back.gif" width=9 height=15 alt="" border=0></a></td>
		<td width=60% align=center nowrap class="channelHeader"><nobr><%=user.getDateFormatter().formatDate(date,DateFormat.FULL)%></nobr></td>
		<td width=19% align=center><A HREF="<%= includer %><%= calendar.getStateAsQueryString(calendar.getNextDay()) %>&module=<%= net.project.base.Module.CALENDAR %>"><img src="<%= SessionManager.getJSPRootURL() %>/images/icons/forward.gif" width=9 height=15 alt="" border=0></a></td>
