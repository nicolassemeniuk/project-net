...
<%@ page 
    ...
    info="include page for detailed view of a phase" 
    language="java" 
...
<%
	String m_phase_xml = m_phase.getXML();
	XMLFormatter m_formatter = new XMLFormatter();
	m_formatter.setStylesheet("/process/include/phaseDetail.xsl");
	String m_output = m_formatter.getPresentation(m_phase_xml);
	out.print(m_output);
%>
