...
public class ProjectActivityServlet extends HttpServlet{
	...
	public void doGet ( HttpServletRequest request, HttpServletResponse response ) throws ServletException{				
		try{
			...
			response.setHeader("Content-Disposition", view + "; filename=ProjectActivity.pdf");
			ByteArrayOutputStream out = (ByteArrayOutputStream)service.createProjectActivityReport();
