...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="personID" select="$translation[@name='personID']"/>
    ...
    <xsl:template match="ResourceAllocationCalendar">
        <table width="100%" border="0">
            <tr>
                <td width="1%">
                    <a>
                        <xsl:attribute name="href">
                            <xsl:text>ResourceAllocations.jsp?module=140&amp;startDate=</xsl:text>
