...
<%
	...
	if ((request.getParameter("theAction") != null) && request.getParameter("theAction").equals("remove"))
	{
		statusMessage.setID(request.getParameter("selected"));
		statusMessage.remove();
		
		pageContext.forward("/admin/status/Main.jsp?module="+Module.APPLICATION_SPACE);
	}
%>