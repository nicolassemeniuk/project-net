...
<%
    ...
    schedule.addFinderFilter(tasksOnly);
...
<%--
<jsp:setProperty name="schedule" property="stylesheet" value="/process/include/phase-tasks-channel.xsl" />
<jsp:getProperty name="schedule" property="presentation" />	  
--%>
 
 <pnet-xml:transform name="schedule" scope="session" stylesheet="/process/include/phase-tasks-channel.xsl">
