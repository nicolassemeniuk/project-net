...
<head>
<title>Form Designer -- Search</title>
...
<tr align="left">
	<td align="left">
		<span class="pageTitle">Form Designer</span>
	</td>
...
<%-- Disabled for now since they are not implemented yet
	<tab:tab label="Search" href='<%="SearchEdit.jsp?module=" + net.project.base.Module.FORM + "&action=" + net.project.security.Action.MODIFY + "&id=" + formDesigner.getID()%>' selected="true" />
...
<tr> 
	<td colspan="3" align="center"><i><%=PropertyProvider.get("prm.project.form.designer.feature.not.implemented.label") %></i></td>
</tr>
</table>
