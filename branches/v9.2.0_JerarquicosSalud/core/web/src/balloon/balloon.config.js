...
BalloonConfig = function(balloon) {
  ...
  balloon.parentID = document.body;
  ...
  balloon.balloonImage  = 'balloon.jpg';    // with alpha channels
  balloon.ieImage       = 'balloon_ie.jpg'; // indexed color, transparent background
  ...
  balloon.upLeftStem    = 'up_left.jpg';
  balloon.downLeftStem  = 'down_left.jpg';
  balloon.upRightStem   = 'up_right.jpg';
  balloon.downRightStem = 'down_right.jpg';

  // A close button for sticky balloons
  // specify the width of your button image
  // if you do not use the default image provided
  balloon.closeButton   = 'project/dashboard_close.gif';
...
BoxConfig = function(box) {
 ...
 box.fontSize    = '12pt';
  ...
  box.closeButton   = 'project/dashboard_close.gif';
  box.closeButtonWidth = 15;
