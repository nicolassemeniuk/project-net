...
/**
  * ValidationErrors provides functionality for maintaing and formatting
  * validation errors that may be displayed to the user.
  * This class is intended to be used as a private member variable of another
  * class that is providing validation facilities.  See {@link IErrorProvider}
  * for details on using this class.
  */
public class ValidationErrors implements java.io.Serializable, IXMLPersistence {
    ...
    /**
     * Returns all error messages formatted in an HTML table.
