...
/**
 * PnSpaceHasSkill generated by hbm2java
 */
@Entity
@Table(name="PN_SPACE_HAS_SKILL"
)
public class PnSpaceHasSkill implements Serializable {


     private PnSpaceHasSkillPK comp_id;
    ...
    public PnSpaceHasSkill(PnSpaceHasSkillPK comp_id) {
        this.comp_id = comp_id;
    }

    public PnSpaceHasSkill(PnSpaceHasSkillPK comp_id, PnSkill pnSkill) {
       this.comp_id = comp_id;
    ...
    public PnSpaceHasSkillPK getComp_id() {
        return this.comp_id;
    }
    
    public void setComp_id(PnSpaceHasSkillPK comp_id) {
        this.comp_id = comp_id;
    }
