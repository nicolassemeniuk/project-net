...
/**
 * PnSpaceHasDirectoryFieldPK generated by hbm2java
 */
@Embeddable
public class PnSpaceHasDirectoryFieldPK implements Serializable {
    ...
    public PnSpaceHasDirectoryFieldPK(Integer spaceId, Integer directoryFieldId) {
    ...
    @Column(name="DIRECTORY_FIELD_ID", nullable=false, length=20)
