...
/**
  * Notification object used for sending information when user forgets password.
  */
public class ForgottenPasswordNotification extends ImmediateNotification {

	/** Stylesheet to use to format forgotten password email */
	public static final String FORGOTTENPASSWORD_NOTIFICATION_STYLE_SHEET = "/registration/nativedir/xsl/ForgottenPassword.xsl";

	public ForgottenPasswordNotification() {
		super();
	...
	public void init(RegistrationBean regBean) {
		...
		setXSLStylesheetPath (FORGOTTENPASSWORD_NOTIFICATION_STYLE_SHEET);


		xml.append (net.project.xml.IXMLTags.XML_VERSION_STRING);

		xml.append ("<forgotten-pswd>");
		xml.append (regBean.getXMLBody());
		xml.append ("<verification-code>" + XMLUtils.escape(regBean.getVerificationCode()) + "</verification-code>");
		xml.append ("</forgotten-pswd>");
