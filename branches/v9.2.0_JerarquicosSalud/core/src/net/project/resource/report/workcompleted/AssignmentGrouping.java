...
public class AssignmentGrouping extends FinderGrouping {
    public AssignmentGrouping(String id, String nameToken, boolean isDefaultGrouping) {
    ...
    public Object getGroupingValue(Object currentObject) throws PersistenceException {
        return (currentObject == null ? null : ((AssignmentWorkLogEntry)currentObject).getObjectID());
    }
    ...
    public String getGroupName(Object currentObject) throws PersistenceException {
        return (currentObject == null ? "" : ((AssignmentWorkLogEntry)currentObject).getObjectName());
    }
}
