...
/**
 * Provides XML formatting facilities for BusinessPortfolios.
 * @author unascribed
 * @since Version 1
 */
public class BusinessPortfolioBean extends BusinessPortfolio implements Serializable {

    /**
     * The XMLFormatter.
     */
    private XMLFormatter xml = null;

    /**
     * Creates an empty BusinessPortfoliOBean.
     */
    public BusinessPortfolioBean() {
