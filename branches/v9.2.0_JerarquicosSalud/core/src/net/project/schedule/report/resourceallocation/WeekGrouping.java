...
/**
 * {@link net.project.base.finder.FinderGrouping} subclass which groups resource
 * allocations according to week.
 *
 * @author Matthew Flower
 * @since Version 7.4
 */
class WeekGrouping extends FinderGrouping {
    /**
     * Public constructor.
     *
     ...
     * groupings.
     */
    public WeekGrouping(String id, boolean isDefaultGrouping) {
        super(id,
            PropertyProvider.get("prm.schedule.report.resourceallocation.weekgrouping.name"),
            isDefaultGrouping);
    }
    ...
    public String getGroupName(Object currentObject) throws PersistenceException {
        ...
        return PropertyProvider.get("prm.schedule.report.resourceallocation.weekgrouping.groupheader.name",
            groupingDateFormatted);
    }
}
