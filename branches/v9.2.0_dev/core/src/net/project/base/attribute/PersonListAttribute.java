...
public class PersonListAttribute extends AbstractAttribute {
     ...
     * @since Gecko
     */
    public PersonListAttribute(String id, String displayName) {
     ...
     * @since Gecko
     */
    public PersonListAttribute(String id, String displayName, boolean required) {
        super(id, displayName, required);
    }


    public PersonListAttribute(String id, String displayName, DomainValues domainValues) {
