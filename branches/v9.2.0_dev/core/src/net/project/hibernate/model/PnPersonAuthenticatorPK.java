...
/**
 * PnPersonAuthenticatorPK generated by hbm2java
 */
@Embeddable
public class PnPersonAuthenticatorPK implements Serializable {
    ...
    public PnPersonAuthenticatorPK(Integer personId, Integer authenticatorId) {
    ...
    @Column(name="AUTHENTICATOR_ID", nullable=false, length=20)
