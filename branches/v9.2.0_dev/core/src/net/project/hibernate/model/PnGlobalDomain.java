...
/**
 * PnGlobalDomain generated by hbm2java
 */
@Entity
@Table(name="PN_GLOBAL_DOMAIN"
)
public class PnGlobalDomain  implements java.io.Serializable {

    /** identifier field */
     private PnGlobalDomainPK comp_id;
    /** persistent field */
    ...
    public PnGlobalDomain(PnGlobalDomainPK comp_id, String codeName, String codeDesc, String codeUrl, Integer presentationSequence, int isDefault, String recordStatus) {
    ...
    public PnGlobalDomainPK getComp_id() {
        return this.comp_id;
    }
    
    public void setComp_id(PnGlobalDomainPK comp_id) {
        this.comp_id = comp_id;
    }
