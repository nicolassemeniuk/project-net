...
/**
 * PnObjectSpace generated by hbm2java
 */
@Entity
@Table(name = "PN_OBJECT_SPACE")
public class PnObjectSpace implements Serializable {

	private PnObjectSpacePK comp_id;

	public PnObjectSpace() {
	}

	public PnObjectSpace(PnObjectSpacePK comp_id) {
	...
	public PnObjectSpacePK getComp_id() {
		return this.comp_id;
	}

	public void setComp_id(PnObjectSpacePK comp_id) {
		this.comp_id = comp_id;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof PnObjectSpace))
			return false;
