...
import net.project.notification.NotificationClob;
import net.project.notification.NotificationManager.AsynchronousNotificationJob;
...
public class DeleteOrphanedNotificationClobJob implements StatefulJob {
    private Logger logger = Logger.getLogger(DeleteOrphanedNotificationClobJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            //delete orphaned notification clobs
            NotificationClob.delete();

        } catch (Exception e) {
        	Logger.getLogger(DeleteOrphanedNotificationClobJob.class).debug("Error executing DeleteOrphanedNotificationClobJob", e);
