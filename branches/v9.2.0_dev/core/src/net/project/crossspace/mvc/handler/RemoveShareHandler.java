...
public class RemoveShareHandler extends Handler {
    public RemoveShareHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public String getViewName() {
        return "/servlet/CrossSpaceController/ShowShares";
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //Get the id's of the shares we are going to remove
        String[] idArray = request.getParameterValues("selected");
        ExportedObject.remove(idArray);
