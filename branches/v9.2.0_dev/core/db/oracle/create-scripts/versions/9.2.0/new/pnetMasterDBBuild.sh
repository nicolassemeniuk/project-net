...
#   PNET_BUILD_DB_SCRIPTS_PATH=/home/trunk/core/db/oracle/create-scripts/versions/9.2.0/new
############################################################################################### 
export PNET_BUILD_DB_SCRIPTS_PATH=/pnet/db/oracle/create-scripts/versions/9.2.0/new/
...
cd ../../..
echo =====================================
echo Applying 9.2.0 upgrade patch
echo =====================================
sqlplus $PNET_BUILD_USER_NAME/$PNET_BUILD_USER_PASSWORD@$PNET_BUILD_DB_DATABASE_NAME @versions/9.2.0/prm_db_patch_9.2.0.sql $PNET_BUILD_APP_USER_NAME $PNET_BUILD_APP_USER_PASSWORD $PNET_BUILD_DB_DATABASE_NAME >> $PNET_BUILD_DB_LOG_PATH
echo =====================================
echo Done.
echo =====================================