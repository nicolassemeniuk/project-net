...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:display="xalan://net.project.base.property.PropertyProvider"
		...
		<table class="summaryTable" cellpadding="0" cellspacing="0" width="97%">
			...
			<tr>
				...
				<td class="tableHeader">
					<xsl:value-of select="display:get('prm.financial.report.resourcestotalcurrentestimatedtotalcost.name')" />
				</td>
				<td class="tableContent">
					<xsl:value-of select="ResourcesTotalCurrentEstimatedTotalCost" />
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td class="tableHeader">
					<xsl:value-of select="display:get('prm.financial.report.materialstotalcurrentestimatedtotalcost.name')" />
				</td>
				<td class="tableContent">
					<xsl:value-of select="MaterialsTotalCurrentEstimatedTotalCost" />
				</td>
				<td></td>
			</tr>
			<tr>
				<td></td>
				<td class="tableHeader">
					<xsl:value-of select="display:get('prm.financial.report.discretionaltotalcurrentestimatedtotalcost.name')" />
				</td>
				<td class="tableContent">
					<xsl:value-of select="DiscretionalTotalCurrentEstimatedTotalCost" />
				</td>
				<td></td>
			</tr>
		</table>
	...
	<xsl:template name="DetailedDataHeader">
		...
		<tr>
			...
			<td class="tableHeader" width="8%">
				<xsl:value-of select="display:get('prm.financial.columndefs.project.resourcescurrentestimatedtotalcost')" />
			</td>
			<td class="tableHeader" width="8%">
				<xsl:value-of select="display:get('prm.financial.columndefs.project.materialscurrentestimatedtotalcost')" />
			</td>
			<td class="tableHeader" width="8%">
				<xsl:value-of select="display:get('prm.financial.columndefs.project.discretionalcurrentestimatedtotalcost')" />
			</td>
			<td></td>
		</tr>
		<tr>
	...
	<xsl:template match="Meta">
		<td class="tableContent" align="left">
			<xsl:value-of select="ResourcesCurrentEstimatedTotalCost" />
		</td>
		<td class="tableContent" align="left">
			<xsl:value-of select="MaterialsCurrentEstimatedTotalCost" />
		</td>
		<td class="tableContent" align="left">
			<xsl:value-of select="DiscretionalCurrentEstimatedTotalCost" />
		</td>
