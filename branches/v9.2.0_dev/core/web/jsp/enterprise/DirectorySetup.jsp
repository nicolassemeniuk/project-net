...
<%@ page 
    ...
    import="net.project.security.SessionManager,
            ...
            net.project.enterprise.EnterpriseMemberWizard"
%>
...
<title><display:get name="prm.business.directorysetup.title" /></title>
<%
     EnterpriseMemberWizard memberWizard = new EnterpriseMemberWizard();
     ...
     pageContextManager.setProperty ("space.main.url", SessionManager.getJSPRootURL() + "/enterprise/Main.jsp");
	 pageContextManager.setProperty ("space.invite.autoaccept.url",
	 		SessionManager.getJSPRootURL() +
			"/enterprise/Main.jsp" +
			"?id=" + EnterpriseSpace.SPACE_ID +
			"&module=" + Module.BUSINESS_SPACE +
			"&external=1");
%>
