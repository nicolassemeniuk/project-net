...
function help() {
	var helplocation=JSPRootURL+"/help/Help.jsp?page=invitation_action";
...
<table width="75%" border="0" cellpadding="0" cellspacing="0">
	<tr class="channelHeader" align="left">
		...
		<th class="channelHeader"><display:get name="prm.base.invitation.status.pagetitle" /></th>
	...
	<tr class="tableContent">
		...
		<td align="left" class="tableContent">
            <display:get name="prm.base.invitation.status.message" />
		</td>
		<td>&nbsp;</td>
	</tr>
</table>
