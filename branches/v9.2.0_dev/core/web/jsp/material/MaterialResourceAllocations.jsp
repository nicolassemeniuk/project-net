...
<%@ page contentType="text/html; charset=UTF-8" info="Allows to see the allocations for a certain material" language="java"     errorPage="/errors.jsp"
...
<html>
<head>
<title><display:get name="prm.material.allocation.title" /></title>
