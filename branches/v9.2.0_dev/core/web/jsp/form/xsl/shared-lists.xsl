...
<xsl:template match="Form">
	...
	<tr class="tableHeader"> 
		...
		<th align="left" nowrap="true" class="tableHeader">Owner</th>
...
<xsl:template match="Form/FormList">
	<tr class="tableContent" align="left"> 
		...
		<td align="left" class="tableContent"><xsl:value-of select="./owner_name"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
