...
<tr>
		...
		<tr>
		<td colspan=2 class="tableContent"><i><%=PropertyProvider.get("prm.project.admin.domain.main.message.label")%></i>
		</td>
		</tr>
<tr><td>&nbsp;</td></tr>
<tr>
		<td rowspan="2" class="tableHeader">&nbsp;&nbsp;<%=PropertyProvider.get("prm.project.admin.domain.user.status.label")%></br>
		...
		<select name="userDomainFilter" multiple height="1">
		<%
	         net.project.security.domain.DomainOptionList optionList = new net.project.security.domain.DomainOptionList();
	       	 optionList.loadAll();
        %>
		<%= optionList.getSelectedDomainOptionList (userList.getUserDomainFilter()) %>
		</select>
		</td>
</tr>	
<tr><td>&nbsp;</td></tr>
...
%>
	...
	<tr class="channelHeader">
        ...
        <tr class="channelHeader">
			 ...
			 <jsp:setProperty name="userList" property="stylesheet" value="/admin/domain/include/xsl/user-list.xsl" /> 
