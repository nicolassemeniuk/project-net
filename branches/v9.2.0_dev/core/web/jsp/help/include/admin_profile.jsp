...
This tab contains information for any contact.   Required fields include:
...
This tab contains physical address information for the contact. As 
appointments and check-out and check-out use GMT times, make sure you 
select the right time zone. To ensure that all means of contact are 
covered, you can add mobile phone number, pager number, and a pager email 
to this user's profile.
<br>&nbsp;
<h2>
<a name="login_tab"></a>Login tab</h2>
This tab contains login, password and Jog question information.  This page, the
administrative version of the page, does not require you to enter the current
password for the user, though the current login name must be entered.  The Jog 
question is used as an additional identifier in case you forget or misplace 
your login information.
<br>&nbsp;
<h2>
<a name="business_tab"></a>Business tab</h2>
The Business tab includes the company name for the contact and includes some 
additional information to help the company track its user base. This information 
is not resold and is kept private according to the policies of this site.
