...
/**
 * Tests {@link AssignmentModifyPercentHandler}.
 * 
 * @author Tim Morrow
 * @since Version 7.7.0
 */
public class AssignmentModifyPercentHandlerTest extends TestCase {
     ...
     */
    public AssignmentModifyPercentHandlerTest(String s) {
        super(s);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(AssignmentModifyPercentHandlerTest.class);
        return suite;
    }
    ...
    /**
     * Tests {@link AssignmentModifyPercentHandler#handleRequest(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}.
     * <p>
    ...
    public void testHandleRequest() throws Exception {
        ...
        WorkingTimeCalendarDefinition calendarDef = WorkingTimeCalendarDefinitionTest.make24HourCalendarDefinition();
        TestWorkingTimeCalendarProvider provider = new TestWorkingTimeCalendarProvider();
        provider.addResourceCalendarDefintion("100", calendarDef);
        assignment.setTimeZone(schedule.getTimeZone());

        scheduleEntry = ScheduleEntryDateCalculatorTest.createTask(new TimeQuantity(8, TimeQuantityUnit.HOUR), Collections.singleton(assignment));
        ...
        // modify the percentage to 100%
        modifiedPercentValue = "100";

        response = new MockHttpServletResponse();
        request = constructRequest(
                "/servlet/ScheduleController/TaskCalculate/AssignmentModifyPercent?action="+Action.MODIFY+"&module=" + Module.SCHEDULE,
                schedule,
                scheduleEntry,
        ...
        Map model = new AssignmentModifyPercentHandler(request).handleRequest(request, response);
     ...
     */
    private static HttpServletRequest constructRequest(String baseURL, Schedule schedule, ScheduleEntry scheduleEntry, String resourceID, String percentValue, AssignmentRoster assignmentRoster) {
