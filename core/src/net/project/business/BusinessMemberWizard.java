...
/**
 * Performs processing for adding team members to a Business Space.
 */
public class BusinessMemberWizard extends net.project.resource.SpaceInvitationManager {
    ...
    /**
         * Creates a new, empty BusinessMemberWizard.
         */
    public BusinessMemberWizard() {
	super();
    }
     ...
     */
    protected void loadSearchableDirectories() throws DirectoryException, PersistenceException {
    ...
    /**
         ...
         */
    public void loadSearchableDirectories(boolean isIncludeCurrentBusiness) throws DirectoryException, PersistenceException {
	...
	for (Iterator it = this.personalSpace.getBusinessSpaces().iterator(); it.hasNext();) {
	    ...
	    if (!bSpace.getID().equals(getUser().getCurrentSpace().getID()) || isIncludeCurrentBusiness) {
	...
	if (directory == null) {
	    throw new net.project.resource.InvitationException("Selected directory not found in Project invitation wizard");
