...
package net.project.view.components;
	 ...
	 * @version $Id: TabSet.java 713 2008-08-19 00:05:22Z homburgs $
	 */
	@IncludeJavaScriptLibrary(value = {"context:src/PnetTabSet.js"})
	@IncludeStylesheet(value = {"context:styles/PnetTabSet.css"})
	public class PnetTabSet implements ClientElement
	{
	    @Inject
	    ...
	    {
	        writer.element("div", "id", getClientId(), "class", "tap5c_tab-set");
	        ...
	        for (String blockId : _panelIds)
	        {
	            ...
	            writer.element("div", "id", "panel_" + blockId,
	                           "class", "tap5c_tab-set-panel" + (_activePanelId.equalsIgnoreCase(blockId) ? " activated" : ""));
	            writer.write(getPanelTitle(blockId));
	            writer.end();
	        }

	        writer.element("div", "class", "tap5c_tab-set-content");
	    }
