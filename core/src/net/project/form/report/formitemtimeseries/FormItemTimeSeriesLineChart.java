...
import net.project.chart.StackedLineChart;
 ...
 * 
 */
public class FormItemTimeSeriesLineChart extends StackedLineChart {
    private FormItemTimeSeriesChartHelper helper = new FormItemTimeSeriesChartHelper();

    public FormItemTimeSeriesLineChart() {
    ...
    private void populateDatasetAndLegend(JFreeChart chart) throws PersistenceException {
        ...
        for (Iterator it = dates.iterator(); it.hasNext(); i++) {
            ...
            for (Iterator it2 = fields.iterator(); it2.hasNext();) {
                ...
                dataset.add(count, new Integer(i), formattedField, false);
            }
        }
    }
