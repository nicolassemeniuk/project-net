 ...
 * with output for each month.  This object shouldn't be instantiated directly.
 * Instead use the variable {@link SQLStatementType#MONTHLY_TIME_SERIES}.
 *
 ...
 * @since Version 7.4
 */
class MonthlyTimeSeries extends SQLStatementType {
    /**
    ...
    private static String POSITIVE_DELTA_SQL =
        ...
        "  AND cd.date_modified > add_months(cal.cal_date, -1) " +
    ...
    private static String NEGATIVE_DELTA_SQL =
        ...
        "     AND c.date_modified > add_months(cal.cal_date, -1) "+
    ...
    private static String DAILY_DELETED_SQL =
        ...
        "     AND ci.crc < cal.cal_date AND ci.crc >=  add_months(cal.cal_date,-1) "+
     ...
     */
    private static String DISPLAY_TOKEN = "prm.form.report.formitemtimeseries.parameter.monthlytimeseries.description";

    /**
     * Public constructor to create a new MonthlyTimeSeries object.
     *
     ...
     */
    public MonthlyTimeSeries(String id) {
