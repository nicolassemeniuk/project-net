...
/**
 * Indicates that a license key is invalid.
 *
 * @author Tim Morrow
...
public class InvalidLicenseKeyException extends LicenseKeyException {
    /**
     * Constructs an empty InvalidLicenseKeyException.
     */
    ...
    /**
     * Constructs an empty InvalidLicenseKeyException with the specified message.
    ...
    /**
     * Constructs an empty InvalidLicenseKeyException with the specified message, indicating
