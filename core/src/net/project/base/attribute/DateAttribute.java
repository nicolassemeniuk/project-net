...
public class DateAttribute extends AbstractAttribute{
    ...
    * @since Gecko
    */
   public DateAttribute (String id, String displayName) {
    ...
    * @since Gecko
    */
   public DateAttribute (String id, String displayName, boolean required) {
    ...
    public AbstractDataTransformer getDataTransformer(String id, IAttribute iAttribute) {
        return new DateDataTransformer(id, iAttribute);
    }
}
