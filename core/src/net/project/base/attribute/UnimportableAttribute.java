...
public class UnimportableAttribute extends AbstractAttribute {
    /**
     ...
     * @since Gecko
     */
    public UnimportableAttribute(String id, String displayName) {
     ...
     * @since Gecko
     */
    public UnimportableAttribute(String id, String displayName, boolean required) {
