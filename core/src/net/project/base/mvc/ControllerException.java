...
/**
 * Provides an exception indicating that some problem occurred in a controller.
 *
 * @author Tim Morrow
 * @since Version 7.6.3
 */
public class ControllerException extends Exception {
    ...
    /**
     * Creates a new ControllerException with the specified message.
    ...
    /**
     * Creates a new ControllerException with the specified message and
     * causing throwable
     * @param message the message indicating the problem that occurred
