...
/**
 * Class which implements blank implementations of the FinderListener interface.
 * Classes may subclass this class so that they can add listeners without having
 * to define methods for every method supported by the FinderListener interface.
 *
 * @author Matthew Flower
 * @since Version 7.4
 */
public class FinderListenerAdapter implements FinderListener {
    /**
