...
/**
 * This type of finder grouping should be used when you do not want to impose
 * any sort of grouping.  This is the default "impose no grouping" selection.
 *
 * @author Matthew Flower
 * @since Version 7.4
 */
public class EmptyFinderGrouping extends FinderGrouping {
    /**
     * Public constructor.
     *
     ...
     * groupings.
     */
    public EmptyFinderGrouping(String id, String nameToken, boolean isDefaultGrouping) {
     ...
     *
     * For the EmptyFinderGrouping object, this method will always return null.
     *
     ...
     * object.
     */
    public Object getGroupingValue(Object currentObject) {
        return null;
    }
     ...
     */
    public String getGroupName(Object currentObject) {
        return null;
    }

    public void accept(IFinderIngredientVisitor visitor) throws VisitException {
        visitor.visitEmptyFinderGrouping(this);
    }
}
