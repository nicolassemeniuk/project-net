...
/** 
 * This class is used for storing project notification events
 *  
 * @author umesha
 */
public class ProjectEvent  extends net.project.notification.Event {
   
	/**
     * Stores the Project Event in the Database
     *
