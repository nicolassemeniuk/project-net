...
/**
 * Performs processing for adding team members to a Project Space.
 *
 * @author Philip Dixon
 * @since Aardvark
 */
public class ProjectMemberWizard extends SpaceInvitationManager {
