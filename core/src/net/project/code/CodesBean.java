...
public class CodesBean implements Serializable {
    ...
    private CodeDomain domain = null;
    ...
    public void setDomain (CodeDomain domain) {
	this.domain = domain;
    }


    public void setDefaulStylesheet() {
	xml.setStylesheet("../code/xsl/option-list.xsl");
    }
	...
	if (xml.getStylesheet() == null)
	    setDefaulStylesheet();

	// return the XML representation of the container's contents
	return ( xml.getPresentation( domain.getXML() ) );
