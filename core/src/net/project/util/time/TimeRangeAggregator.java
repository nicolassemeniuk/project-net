 ...
 * 
 * For example, let's assume that you have created a number of assignments. All
 * these assignments have a date range in which they occur as well as a
...
public class TimeRangeAggregator {
	 ...
	 * 
	 * @param value
	 *            a <code>ITimeRangeValue</code> object.
	 */
	 ...
	 * 
	 * @param testStart
	 *            a <code>Date</code> which indicates the start of the date
	 *            range we are going to check.
	 * @param testEnd
	 *            a <code>Date</code> which indicates the end of the date range
	...
	/**
	 * On this method we iterate a list of nodes [startDate,endDate,value] from
	 * this class and try to find a concurrent date on that list against those
	 * passed as parameters.
	 * 
	 * @param testStart
	 *            the Start Date for the interval to check against.
	 * @param testEnd
	 *            the End Date for the interval to check against.
	 * @return true, in case ANY interval on the list is concurrent against the
	 *         start/end interval, false otherwise.
	 */
	@SuppressWarnings("rawtypes")
	public boolean existConcurrent(Date testStart, Date testEnd) {
