...
/**
 * This code has been adapted from Marc Mnich's RandomGUID object which is
 * available on <a href="http://www.javaexchange.com">Java Exchange</a>.  Any
 * diffs in this file have been made available to Marc in case he wishes to
 * include them in future versions of his object.  Marc's original comments are
 * listed below.
 * <br>
 * -------------------------------------------------------------------<br>
...
public class RandomGUID extends Object {
    ...
    public RandomGUID(boolean secure, String clientIPAddress) {
        getRandomGUID(secure, clientIPAddress);
    }

    private void getRandomGUID(boolean secure) {
        getRandomGUID(secure, s_id);
    }

    /*
     * Method to generate the random GUID
     */
    private void getRandomGUID(boolean secure, String ipAddress) {
        ...
        try {
            ...
            // Make sure a valid IP address was passed in.  Use this
            // machine's IP address if a valid one wasn't passed in.
            ...
            sbValueBeforeMD5.append(ipAddress);
    ...
    public static void main(String args[]) {
        for (int i=0; i< 100; i++) {
	    RandomGUID myGUID = new RandomGUID(true, "127.0.0.1");
