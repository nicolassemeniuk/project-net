...
public interface IPnSpaceHasMaterialService {
	 ...
	 */
	public PnSpaceHasMaterial getPnSpaceHasMaterial(String spaceId, String MaterialId);
	 ...
	 *            the id of the space.
	 * @param material
	 *            the material to associate.
	 */
	public void associateMaterial(String spaceId, String materialId);

	/**
	 * Obtain the owner space of a material.
	 * 
	 * @param materialId
	 *            the id of the material.
	 * @return the id of the space owner of the material.
	 */
