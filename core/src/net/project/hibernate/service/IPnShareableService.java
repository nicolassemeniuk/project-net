 ...
 *
 */
public interface IPnShareableService {
    
    /**
     * Gets {@link PnShareable} for given objectId.
     * @param objectId
     * @return <code>PnShareable</code>
     */
    public PnShareable getShareable(Integer objectId);
    
    /**
     * Updates passed {@link PnShareable}. 
     * @param pnShareable
     */
    public void updateShareable(PnShareable pnShareable);
    
    /**
     * Saves new {@link PnShareable}.
     * @param pnShareable
     * @return PK of saved <code>PnShareable</code>
     */
