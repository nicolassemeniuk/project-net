...
public interface IPnAssignmentWorkDAO extends IDAO<PnAssignmentWork, Integer> {

	/** Get Total work done for assignment between startDate and endDate
	 * @param personIds
	 * @param startDate
	 * @param endDate
	 * @param spaceId
	 * @return List if PnAssignmentWork instances
	 */
