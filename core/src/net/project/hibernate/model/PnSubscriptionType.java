...
/**
 * PnSubscriptionType generated by hbm2java
 */
@Entity
@Table(name="PN_SUBSCRIPTION_TYPE"
)
public class PnSubscriptionType implements Serializable {
    ...
    public PnSubscriptionType(Integer subscriptionTypeId) {
        this.subscriptionTypeId = subscriptionTypeId;
    }

    public PnSubscriptionType(Integer subscriptionTypeId, String tableName, String name, String description, String recordStatus, Date crc) {
       this.subscriptionTypeId = subscriptionTypeId;
