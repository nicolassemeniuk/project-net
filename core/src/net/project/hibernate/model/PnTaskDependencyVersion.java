...
/**
 * PnTaskDependencyVersion generated by hbm2java
 */
@Entity
@Table(name="PN_TASK_DEPENDENCY_VERSION"
)
public class PnTaskDependencyVersion implements Serializable {


     private PnTaskDependencyVersionPK comp_id;
     private Integer lag;
    ...
    public PnTaskDependencyVersion(PnTaskDependencyVersionPK comp_id) {
        this.comp_id = comp_id;
    }

    public PnTaskDependencyVersion(PnTaskDependencyVersionPK comp_id, Integer lag, String lagUnits) {
       this.comp_id = comp_id;
       this.lag = lag;
    ...
    public PnTaskDependencyVersionPK getComp_id() {
        return this.comp_id;
    }
    
    public void setComp_id(PnTaskDependencyVersionPK comp_id) {
        this.comp_id = comp_id;
    }
