...
/**
 * PnPersonProperty generated by hbm2java
 */
@Entity
@Table(name = "PN_PERSON_PROPERTIES")
public class PnPersonProperty implements Serializable {

	private PnPersonPropertyPK comp_id;
	...
	public PnPersonProperty(PnPersonPropertyPK comp_id) {
		this.comp_id = comp_id;
	}

	public PnPersonProperty(PnPersonPropertyPK comp_id, PnPerson pnPerson) {
		this.comp_id = comp_id;
	...
	@AttributeOverrides( {
			...
			@AttributeOverride(name = "context", column = @Column(name = "CONTEXT", nullable = false, length = 256)),
			@AttributeOverride(name = "property", column = @Column(name = "PROPERTY", nullable = false, length = 256)),
			@AttributeOverride(name = "value", column = @Column(name = "VALUE", nullable = false, length = 256)) })
	public PnPersonPropertyPK getComp_id() {
		return this.comp_id;
	}

	public void setComp_id(PnPersonPropertyPK comp_id) {
		this.comp_id = comp_id;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof PnPersonProperty))
			return false;
