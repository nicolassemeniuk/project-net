...
/**
 * PnPhaseHasTask generated by hbm2java
 */
@Entity
@Table(name = "PN_PHASE_HAS_TASK")
public class PnPhaseHasTask implements Serializable {

	private PnPhaseHasTaskPK comp_id;
	...
	public PnPhaseHasTask(PnPhaseHasTaskPK comp_id) {
		this.comp_id = comp_id;
	}

	public PnPhaseHasTask(PnPhaseHasTaskPK comp_id, PnPhase pnPhase, PnTask pnTask) {
		this.comp_id = comp_id;
	...
	public PnPhaseHasTaskPK getComp_id() {
		return this.comp_id;
	}

	public void setComp_id(PnPhaseHasTaskPK comp_id) {
		this.comp_id = comp_id;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof PnPhaseHasTask))
			return false;
