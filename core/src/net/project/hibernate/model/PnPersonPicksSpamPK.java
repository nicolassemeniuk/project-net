...
/**
 * PnPersonPicksSpamPK generated by hbm2java
 */
@Embeddable
public class PnPersonPicksSpamPK implements Serializable {
    ...
    public PnPersonPicksSpamPK(Integer personId, Integer spamTypeCode) {
    ...
    @Column(name="SPAM_TYPE_CODE", nullable=false, length=4)
