...
/**
 * PnPersonHasProfCertPK generated by hbm2java
 */
@Embeddable
public class PnPersonHasProfCertPK implements Serializable {
    ...
    public PnPersonHasProfCertPK(Integer personId, Integer profCertCode) {
    ...
    @Column(name="PROF_CERT_CODE", nullable=false, length=4)
