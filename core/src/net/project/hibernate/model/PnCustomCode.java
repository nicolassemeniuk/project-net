...
/**
 * PnCustomCode generated by hbm2java
 */
@Entity
@Table(name = "PN_CUSTOM_CODE")
public class PnCustomCode implements java.io.Serializable {

	private PnCustomCodePK comp_id;
	...
	public PnCustomCode(PnCustomCodePK comp_id, String codeName, int isDefault, String recordStatus) {
	...
	public PnCustomCode(PnCustomCodePK comp_id, String codeName, String codeDesc, String codeUrl,
			Integer presentationSequence, int isDefault, String recordStatus, PnObject pnObject, PnCodeType pnCodeType) {
		this.comp_id = comp_id;
		this.codeName = codeName;
	...
	public PnCustomCodePK getComp_id() {
		return this.comp_id;
	}

	public void setComp_id(PnCustomCodePK comp_id) {
		this.comp_id = comp_id;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof PnCustomCode))
			return false;
