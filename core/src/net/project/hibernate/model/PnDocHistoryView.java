...
/**
 * PnDocHistoryView generated by hbm2java
 */
@Entity
@Table(name="PN_DOC_HISTORY_VIEW"
)
public class PnDocHistoryView  implements java.io.Serializable {
    ...
    public PnDocHistoryView() {
    }

    public PnDocHistoryView(BigDecimal documentId, String documentName, BigDecimal docHistoryId, String action, String actionName, BigDecimal actionById, String actionBy, Date actionDate, String actionComment) {
