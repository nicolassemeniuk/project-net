...
/**
 * PnJobDescriptionLookup generated by hbm2java
 */
@Entity
@Table(name="PN_JOB_DESCRIPTION_LOOKUP"
)
public class PnJobDescriptionLookup  implements java.io.Serializable {
    ...
    @Id 
    @Column(name="JOB_DESCRIPTION_CODE", nullable=false)
    ...
    @Column(name="JOB_DESCRIPTION", nullable=false, length=80)
