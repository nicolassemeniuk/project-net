...
/**
 * PnDocContainerHasObject generated by hbm2java
 */
@Entity
@Table(name = "PN_DOC_CONTAINER_HAS_OBJECT")
public class PnDocContainerHasObject implements java.io.Serializable {

	/** identifier field */
	private PnDocContainerHasObjectPK comp_id;
	...
	public PnDocContainerHasObject(PnDocContainerHasObjectPK comp_id) {
		this.comp_id = comp_id;
	}

	public PnDocContainerHasObject(PnDocContainerHasObjectPK comp_id, PnObject pnObject, PnDocContainer pnDocContainer) {
		this.comp_id = comp_id;
	...
	public PnDocContainerHasObjectPK getComp_id() {
		return this.comp_id;
	}

	public void setComp_id(PnDocContainerHasObjectPK comp_id) {
		this.comp_id = comp_id;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof PnDocContainerHasObject))
			return false;
