...
/**
 * PnObjectTypeSubscription generated by hbm2java
 */
@Entity
@Table(name = "PN_OBJECT_TYPE_SUBSCRIPTION")
public class PnObjectTypeSubscription implements Serializable {

	private PnObjectTypeSubscriptionPK comp_id;
	...
	public PnObjectTypeSubscription(PnObjectTypeSubscriptionPK comp_id) {
		this.comp_id = comp_id;
	}

	public PnObjectTypeSubscription(PnObjectTypeSubscriptionPK comp_id, PnSubscription pnSubscription) {
		this.comp_id = comp_id;
	...
	public PnObjectTypeSubscriptionPK getComp_id() {
		return this.comp_id;
	}

	public void setComp_id(PnObjectTypeSubscriptionPK comp_id) {
		this.comp_id = comp_id;
	}
	...
	public boolean equals(Object other) {
		if ((this == other))
			return true;
		if (!(other instanceof PnObjectTypeSubscription))
			return false;
