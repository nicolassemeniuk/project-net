...
public class ValidationErrors implements java.io.Serializable, IXMLPersistence {
    ...
    private String getErrorHTML(String fieldID, String prefix, String suffix) {
        ...
        if (entry != null) {
            ...
            if (fieldName == null) {
                ...
                fieldName += PropertyProvider.get("prm.news.validationerrors.colonspace.punctuation");
            }
            if (error == null) {
                error = "";
            }
    ...
    public String getAllErrorsDefaultPresentation() {
        ...
        if (hasErrors()) {
            ...
            html.append("<tr class=\"fieldWithError\"> "+
                        "<td colspan=\"2\">" +
                        PropertyProvider.get("prm.news.validationerrors.haserrors.message") + 
                        "</td></tr>\n");
            ...
            while (it.hasNext()) {
                ...
                if (fieldName == null) {
                    ...
                    fieldName += PropertyProvider.get("prm.news.validationerrors.spacehyphenspace.punctuation");
                }
                if (error == null) {
                    error = "";
                }
    ...
    public String getAllErrorsRemovePresentation() {
        ...
        if (hasErrors()) {
            ...
            html.append("<tr class=\"fieldWithError\"> "+
                        "<td colspan=\"2\">" + 
                        PropertyProvider.get("prm.news.validationerrors.hasremoveerrors.message") + 
                        "</td></tr>\n");
            Iterator it = errorOrder.iterator();
            while (it.hasNext()) {
                entry = (Entry) errorMap.get(it.next());
