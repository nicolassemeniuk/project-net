...
public class BaselineModifyHandler extends AbstractBaselineModifyHandler {
    public BaselineModifyHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Baseline currentBaseline = getBaseline(request, true);
        model.put("baseline", currentBaseline);

        String reloadURL = SessionManager.getJSPRootURL()+"/servlet/ScheduleController/Baseline/Modify";
        model.put("reloadURL", reloadURL);
        String reloadParams = "module="+Module.SCHEDULE+"&action="+Action.MODIFY+"&baselineID="+currentBaseline.getID();
