...
/**
 * Handle the user's request through the interface to remove a baseline.
 */
public class BaselineRemoveHandler extends Handler {
    public BaselineRemoveHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public void validateSecurity(int module, int action, String objectID, HttpServletRequest request) throws AuthorizationFailedException, PnetException {
        AccessVerifier.verifyAccess(Module.SCHEDULE, Action.DELETE);
    }
