...
public class BaselineViewHandler extends Handler {
    public BaselineViewHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public String getViewName() {
        return "/schedule/baseline/View.jsp";
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Baseline baseline = finder.findBaseline(request.getParameter("baselineID"));
        model.put("baseline", baseline);
