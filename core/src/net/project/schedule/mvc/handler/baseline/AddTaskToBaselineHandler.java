...
public class AddTaskToBaselineHandler extends AbstractTaskEditProcessingHandler {
    private String id;
     ...
     */
    public AddTaskToBaselineHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    private void addTaskToBaseline(String id, String baselineID) throws PersistenceException {
        Baseline.baselineTask(id, baselineID);
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(entry == null) {
            ...
            if (Validator.isBlankOrNull(baselineID)) {
                ErrorDescription ed = new ErrorDescription(PropertyProvider.get("prm.schedule.error.message.nobaseline"));
                errorReporter.addError(ed);
                model.put("errorReporter", errorReporter);
            } else {
                //Refresh the baseline
                addTaskToBaseline(id, baselineID);
                //reload entry.
                entry = getScheduleEntry(id, request);
            }
