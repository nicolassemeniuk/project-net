 ...
 * @since Version 7.7.0
 */
abstract class AbstractAssignmentChangeHandler extends Handler {

    private static final Logger LOGGER = Logger.getLogger(AbstractAssignmentChangeHandler.class);

    AbstractAssignmentChangeHandler(HttpServletRequest request) {
        super(request);
    }
