...
/**
 * Class which does all of the logic required to load the TaskAssignments page.
 *
 * @author Matthew Flower
 * @since Version 7.6.3
 */
public class TaskAssignmentHandler extends AbstractTaskAssignmentHandler {

    public TaskAssignmentHandler(HttpServletRequest request) {
        super(request);
        setViewName("/schedule/TaskViewAssignments.jsp");
    }
