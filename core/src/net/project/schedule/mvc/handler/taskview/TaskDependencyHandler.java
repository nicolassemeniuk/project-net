...
public class TaskDependencyHandler extends AbstractTaskViewHandler {
    public TaskDependencyHandler(HttpServletRequest request) {
        super(request);
        setViewName("/schedule/TaskDependencies.jsp");
    }
