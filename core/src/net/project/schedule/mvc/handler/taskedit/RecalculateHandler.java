...
/**
 * This handler processes the request of a user to "recalculate" the values
 * shown on the task edit screen.
 *
 * @author Matthew Flwoer
 * @since Version 7.6
 */
public class RecalculateHandler extends AbstractTaskEditProcessingHandler {
     ...
     */
    public RecalculateHandler(HttpServletRequest request) {
        super(request);
    ...
    public void validateSecurity(int module, int action, String objectID,
        ...
        //None required -- this will be dealt with after the redirect redirect
    }
