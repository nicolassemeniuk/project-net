...
|     $Author: umesha $
|              
| HistoryList is a simple subclass of ArrayList which provides XML
| facilities.                                                         
+----------------------------------------------------------------------*/
...
/**
  * HistoryList provides XML facilities for an ArrayList of
  * Historys
  */
public class HistoryList extends ArrayList
    ...
    /**
      * Returns the individual History elements
      * @return XML elements as string
      */
    private String getXMLElements() {
        StringBuffer xml = new StringBuffer();
        // Add each History XML element to string
        for (int i=0; i < size(); i++) {
            xml.append( ((History)get(i)).getXMLBody() );
        }
        return xml.toString();
    }
    ...
    /**
      * Return the HistoryList XML including the XML version tag
    ...
    /**
      * Return the HistoryList XML without the XML version tag
      * @return XML string
      */
