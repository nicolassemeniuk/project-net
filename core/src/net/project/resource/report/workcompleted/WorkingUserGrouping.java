...
public class WorkingUserGrouping extends FinderGrouping {
    public WorkingUserGrouping(String id, String nameToken, boolean isDefaultGrouping) {
    ...
    public Object getGroupingValue(Object currentObject) throws PersistenceException {
        return (currentObject == null ? null : ((AssignmentWorkLogEntry)currentObject).getAssigneeID());
    }
...
//        return (currentObject == null ? null : ((AssignmentWorkLogEntry)currentObject).getAssigneeID());
        return (currentObject == null ? null : ((AssignmentWorkLogEntry)currentObject).getAssigneeName());
    }
}
