...
set PNET_BUILD_DB_SCRIPTS_PATH=c:\db\oracle\create-scripts\versions\9.2.0\new
...
set PNET_BUILD_DB_DATABASE_NAME=orcl
...
set PNET_BUILD_DB_DATAFILE_PATH=C:\oracle\product\10.2.0\oradata\%PNET_BUILD_DB_DATABASE_NAME%\
