...
BEGIN
    ...
    if (i_is_use_scenario_null > 0) then
        ...
        INSERT INTO pn_methodology_space
            (methodology_id, methodology_name, methodology_desc, use_scenario_clob,
             ...
             modified_date, record_status, crc, is_used, based_on_space_id)
         VALUES
            (v_object_id, i_name, i_description, null, i_is_global,
             NULL, i_creator_id, i_creator_id, v_timestamp,
             v_timestamp, g_active_record_status, v_timestamp, 1, i_based_on_space_id)
         returning
    ...
    FROM
        pn_module
    WHERE
        module_id IN (10, 20, 30, 40, 60, 70, 90, 100, 110, 120, 140, 150, 180, 190, 200, 210, 310, 330, 340, 380);
    ...
    */
    ...
    /* ------------------ Schedule ----------------------- */
    SCHEDULE.STORE_PLAN('Project Plan', 'Main Project Plan', null, null, 1, null, null, i_creator_id, v_object_id, null, null, null, null, null, '50', null, 1, 0, 8, 40, 20, 'PERSONAL', v_plan_id);
