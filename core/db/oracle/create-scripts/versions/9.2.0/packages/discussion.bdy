...
----------------------------------------------------------------------
    ...
    is
        ...
        is
            select pohd.discussion_group_id
            from pn_object_has_discussion pohd, pn_discussion_group pdg 
            where pohd.object_id = i_space_id and
                  pohd.discussion_group_id = pdg.discussion_group_id and
                  pdg.record_status = 'A';
