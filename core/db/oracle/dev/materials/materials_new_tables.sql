...
CREATE TABLE PN_MATERIAL_ASSIGNMENT (
  ...
  constraint MATERIAL_ASSIGNMENT_FK1 FOREIGN KEY (OBJECT_ID) REFERENCES PN_OBJECT(OBJECT_ID),
  constraint MATERIAL_ASSIGNMENT_FK2 FOREIGN KEY (ASSIGNOR_ID) REFERENCES PN_PERSON(PERSON_ID),
