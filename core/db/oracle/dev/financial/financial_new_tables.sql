...
CREATE TABLE PN_FINANCIAL (
  FINANCIAL_ID number(20),
  FINANCIAL_NAME varchar(40),
  RECORD_STATUS varchar(1),
  constraint FINANCIAL_PK primary key (FINANCIAL_ID),
  constraint RECORD_STATUS_M1 check (RECORD_STATUS in ('A','D')),
);
CREATE OR REPLACE SYNONYM PNET_USER.PN_FINANCIAL FOR PNET.PN_FINANCIAL;
