...
// -->
function detectBrowser(redirect_URL) {
    var goodBrowser = false;

    //Check for IE or Nav 6 -- these are the supported browsers
    if (is_ie5_5up || is_nav6up) {
        goodBrowser = true;
    }

    //We'll let konqueror, Mozilla, and Firebird by too.
    if (is_moz || is_fb || is_konq) {
        goodBrowser = true;
    }
