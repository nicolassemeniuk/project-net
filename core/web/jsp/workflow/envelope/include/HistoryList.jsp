...
<jsp:useBean id="envelopeManagerBean" class="net.project.workflow.EnvelopeManagerBean" scope="session" />
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
  		<tr class="channelHeader" align="left">
		    ...
		    <th class="channelHeader">&nbsp;<%=PropertyProvider.get("prm.workflow.envelope.include.historylist.channel.history.title")%></th>
        ...
        <tr>
            ...
            <td colspan="2">
				...
				<jsp:setProperty name="envelopeManagerBean" property="stylesheet" value="/workflow/envelope/include/xsl/history_list.xsl" />
				<jsp:getProperty name="envelopeManagerBean" property="historyListPresentation" />
            </td>
			<td>&nbsp;</td>
        </tr>
    </table>
