...
<%
	//FIX: bug393
	SessionManager.getSecurityProvider().securityCheck(null, Integer.toString(net.project.base.Module.WORKFLOW), Action.CREATE);
...
<form method="post" action="<session:getJSPRootURL />/workflow/envelope/EnvelopeWizardPage1Processing.jsp">
      ...
      <tr> 
        ...
        <td  align="left" nowrap> 
	        <select name="workflowID">
			    <option value=""></option>
				<jsp:setProperty name="envelopeManagerBean" property="stylesheet" value="/workflow/xsl/workflow_list_option.xsl" />
