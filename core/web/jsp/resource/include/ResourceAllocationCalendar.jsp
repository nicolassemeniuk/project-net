...
<jsp:useBean id="rc" class="net.project.resource.ResourceAllocationCalendar" scope="page"/>
...
<%
    ...
    rc.load(request.getParameter("personID"));
%>
<html>
<head>
<title></title>
...
<pnet-xml:transform name="rc" scope="page" stylesheet="/resource/xsl/resource-allocation-calendar.xsl">
    ...
    <pnet-xml:property name="personID" value='<%=request.getParameter("personID")%>'/>
</pnet-xml:transform>
