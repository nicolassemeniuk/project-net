...
<%
	...
	docManager.getDocumentSpace();
	if(request.getParameter("referer") == null)
		container.setID( docManager.getCurrentContainerID() );
	else
		container.setID( docManager.getRootContainerID() );
...
<tr>
	<td align="left" class="tableContent">
		<jsp:setProperty name="path" property="stylesheet" value="/trashcan/xsl/del-container-path.xsl" />
...
documentList.setInclude("/trashcan/include/DeletedDocumentsList.jsp");
