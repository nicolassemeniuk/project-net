...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <xsl:for-each select="document_properties">
                ...
                <tr>
                    ...
                    <td colspan="4" align="left" class="tableContent">
                        <a target="view_window" href="{./jsp_root_url}/servlet/DownloadDocument?id={./object_id}&amp;status=D">
                ...
                <tr>
                    ...
                    <td align="left" class="tableContent">
                        <xsl:value-of select="format:formatText(./notes)"/>
                    </td>
                    <td align="right" class="tableHeader">
    ...
    <xsl:template match="node">
        ...
        <a target="main" href="{/document_properties/jsp_root_url}/document/TraverseFolderProcessing.jsp?id={object_id}&amp;module=330&amp;action=256">
            <xsl:value-of select="name"/>
        </a>
    </xsl:template>
</xsl:stylesheet>
