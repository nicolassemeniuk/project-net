...
<xsl:template match="SummaryData">    
    ...
    <tr class="channelHeader">
        <td class="channelHeader" width="1%"><img src="../images/icons/channelbar-left_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
        <td class="channelHeader"><xsl:value-of select="display:get('prm.financial.report.common.reportsummary.name')"/></td>
        <td class="channelHeader" colspan="3"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
        <td class="channelHeader" align="right" width="1%"><img src="../images/icons/channelbar-right_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
    </tr>
    <tr>
        <td></td>    
        <td class="tableHeader" align="left" width="40%"><xsl:value-of select="display:get('prm.financial.report.totalprojects.name')"/></td>
        <td class="tableContent" align="left" width="9%"><xsl:value-of select="ProjectCount"/></td>
        <td class="chartCell" width="49%" align="center" rowspan="5"><xsl:if test="ChartURL"><img src="{ChartURL}"/></xsl:if></td>
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.financial.report.totalactualcost.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TotalActualCostToDate"/></td>
        <td></td>    
    </tr>
        <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.financial.report.totalestimatedcost.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TotalCurrentEstimatedTotalCost"/></td>
        <td></td>    
    </tr>
        <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.financial.report.totalbudgetedcost.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TotalBudgetedCost"/></td>
        <td></td>    
    </tr>    
    </table>
</xsl:template>
...
<xsl:template name="DetailedDataHeader">
    <tr class="channelHeader">
        <td class="channelHeader" width="1%"><img src="../images/icons/channelbar-left_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
        <td class="channelHeader"><xsl:value-of select="display:get('prm.financial.columndefs.projects.name')"/></td>
        <td class="channelHeader" colspan="7"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
        <td class="channelHeader" align="right" width="1%"><img src="../images/icons/channelbar-right_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
    </tr>
    <tr>
        <td></td>    
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.financial.columndefs.project.name')"/></td>
        <td class="tableHeader" width="17%"><xsl:value-of select="display:get('prm.financial.columndefs.project.description')"/></td>        
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.financial.columndefs.project.actualcost')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.financial.columndefs.project.currentestimatedcost')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.financial.columndefs.project.budgetedcost')"/></td>
        <td></td>
    </tr>
    <tr>
        <td></td>    
...
<xsl:template match="ProjectSpace" >	
	<tr>
		...
		<td class="tableContent" align="left">
			<xsl:value-of select="ActualCostToDate" />
		</td>
		<td class="tableContent" align="left">
			<xsl:value-of select="CurrentEstimatedTotalCost" />
		</td>
		<td class="tableContent" align="left">
			<xsl:value-of select="BudgetedTotalCost" />			
		</td>
		<td></td> 			
	</tr>
