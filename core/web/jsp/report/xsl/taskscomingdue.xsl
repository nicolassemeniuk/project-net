...
<xsl:template match="SummaryData">
    ...
    <tr>
        <td></td>    
        <td class="tableHeader" align="left" width="40%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.totalnumberoftasks.name')"/></td>
        <td class="tableContent" align="left" width="9%"><xsl:value-of select="TaskCount"/></td>
        <td class="chartCell" width="49%" align="center" rowspan="5"><img src="{ChartURL}"/></td>
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.tasksduetoday.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TasksDueToday"/></td>
        <td></td>    
    </tr>    
    <tr>
        <td></td>
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.tasksduetomorrow.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TasksDueTomorrow"/></td>
        <td></td>
    </tr>
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.tasksdueinnext7.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TasksDueInNext7Days"/></td>        
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.tasksduenextmonth.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TasksDueInNextMonth"/></td>        
        <td></td>    
    </tr>    
    </table>
</xsl:template>
...
<xsl:template name="DetailedDataHeader">
    <tr class="channelHeader">
        <td class="channelHeader" width="1%"><img src="../images/icons/channelbar-left_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
        <td class="channelHeader"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.taskscomingdue.name')"/></td>
        <td class="channelHeader" colspan="7"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
        <td class="channelHeader" align="right" width="1%"><img src="../images/icons/channelbar-right_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
    </tr>
    <tr>
        <td></td>    
        <td class="tableHeader" width="17%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.taskname.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.tasktype.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.start.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.finish.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.workcomplete.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.totalwork.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.percentcomplete.name')"/></td>
        <td class="tableHeader" width="17%"><xsl:value-of select="display:get('prm.schedule.report.taskscomingduereport.resources.name')"/></td>
        <td></td>    
    </tr>
    <tr>
        <td></td>    
