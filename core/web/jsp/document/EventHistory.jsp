...
<%
	...
	if ((!id.equals(document.getID())) || (module != docManager.getModuleFromContainerID(document.getContainerID()))  || (action != net.project.security.Action.VIEW)) 
	       throw new net.project.security.AuthorizationFailedException(PropertyProvider.get("prm.document.eventhistory.authorizationfailed.message"));
...
<form method="post" action="<%=SessionManager.getJSPRootURL()%>/servlet/DocumentActionBroker" name="">
	...
	<table border="0" cellspacing="0" cellpadding="0" vspace="0">
		...
		<table border="0" vspace="0" cellpadding="2" cellspacing="0" width="100%">
          ...
          <tr>
            <th align="right" width="140" class="tableHeader"><display:get name="prm.document.eventhistory.documentname.label" /></th>
          ...
          <tr>
            <th align="right" width="140" class="tableHeader"><display:get name="prm.document.eventhistory.filename.label" /></th>
            <th nowrap align="right" width="5">&nbsp;</th>
            <td align="left" width="500" class="tableContent"><jsp:getProperty name="document" property="shortFileName" /> &nbsp;</td>
            <td align="left">&nbsp;</td>
          </tr>
          <tr>
            <th align="right" width="140" class="tableHeader"><display:get name="prm.document.eventhistory.description.label" /></th>
            <th nowrap align="right" width="5">&nbsp;</th>
          ...
          <tr>
            ...
            <!-- HISTORY OUTPUT GOES HERE -->
              ...
              <table border="0" width="100%" vspace="0">
                <tr align="left"> 
                  <td width="22%" nowrap class="tableHeader"><display:get name="prm.document.eventhistory.action.label" /></td>
                  <td width="39%" nowrap class="tableHeader"><display:get name="prm.document.eventhistory.notes.label" /></td>
                  <td width="16%" nowrap class="tableHeader"><display:get name="prm.document.eventhistory.actionby.label" /></td>
                  <td width="23%" nowrap class="tableHeader"><display:get name="prm.document.eventhistory.actiondate.label" /></td>
                </tr>

              	<jsp:setProperty name="document" property="stylesheet" value="/document/xsl/document-events.xsl" /> 
                <jsp:getProperty name="document" property="eventsPresentation" />
