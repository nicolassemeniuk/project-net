...
<title><%=PropertyProvider.get("prm.registration.forgottenpasswordwizard.confirmationpage.title")%></title>
...
<table width=100% cellpadding=1 cellspacing=0 border=0>
  	<tr>
 		...
 		<td align="right" class="regBanner"><%=PropertyProvider.get("prm.registration.forgottenpasswordwizard.confirmation.pagetitle")%>&nbsp;</td>
 	</tr>
</table>
</div>
...
<table width=80% cellpadding=0 cellspacing=0 border=0>
    ...
    <tr>
        ...
        <td colspan="2" align="center">
			<b><%=PropertyProvider.get("prm.registration.forgottenpasswordwizard.confirmation.changed.message")%></b><p>
        </td>
        <td>&nbsp;</td>
    </tr>
</table>
...
<tb:toolbar style="action" showLabels="true" bottomFixed="true">
	<tb:band name="action">
		<tb:button type="submit" label='<%=PropertyProvider.get("prm.registration.forgottenpasswordwizard.confirmation.button.return.label")%>' function="javascript:cancel();" />
	</tb:band>
</tb:toolbar>
