...
|
| Controller for managing LDAP directory authorization
| during registration
|--------------------------------------------------------------------%>
<%@ page
        ...
        if (theAction != null && theAction.equals("next")) {
            ...
            if (directory.isAuthenticated()) {
                ...
                if (entry.getEmail() == null || entry.getEmail().trim().length() == 0) {
                    throw new net.project.base.directory.DirectoryException(PropertyProvider.get("prm.registration.authorization.error.emailnotfound.message"));
                }
                ...
                request.setAttribute("errorMessage", PropertyProvider.get("prm.registration.authorization.error.invalidlogin.message"));
                pageContext.forward("/registration/LDAPDirectoryAuthorization.jsp");
            }
