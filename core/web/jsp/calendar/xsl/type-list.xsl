...
<table  width="100%" cellpadding="0" border="0" cellspacing="1">
	<tr>
		<td>
			<table cellpadding="0" cellspacing="1" width="100%" border="0" vspace="0">
			<tr class="tableHeader">
				<td class="tableHeader" width="5%"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
				<td class="tableHeader" width="35%"><xsl:value-of select="display:get('prm.calendar.view.timeframe.name.label')"/></td>
				<td class="tableHeader" width="20%"><xsl:value-of select="display:get('prm.calendar.view.timeframe.date.label')"/></td>
				<td class="tableHeader" width="20%" nowrap="1"><xsl:value-of select="display:get('prm.calendar.view.timeframe.time.label')"/></td>
				<td class="tableHeader" width="20%"><xsl:value-of select="display:get('prm.calendar.view.timeframe.location.label')"/></td>
			</tr>
		<tr class="tableLine">
...
<xsl:template match="calendar/meeting">
       	<tr class="tableContent">
			...
			<td class="tableContent"><xsl:value-of select="./startWeekDay"/><BR /><xsl:value-of select="./startDate"/></td>
...
<xsl:template match="calendar/task[isMilestone=0]|calendar/summary[isMilestone=0]">
       	<tr class="tableContent">
			...
			<td colspan="2" width="150" class="tableContent">
