...
<form name="Login" action="<%= SessionManager.getJSPRootURL() %>/shadowLoginProcessing.jsp" onSubmit="return processForm(this);" method="POST">
    ...
    <td colspan="2" valign="top">
      <table width="900" height="390" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td height="49" colspan="2" valign="top"><span class="style7"><span class="style8"><display:get name="prm.project.login.login_header_text-1" /> (Shadow user login)</td>
          <td width="17"></td>
            ...
            <tr>
              ...
              <td valign="middle" bgcolor="D2E2F2"><span class="style2">
                <input type="Text" name="J_USERNAME" size="20" maxlength="32">
						...
						<input type="hidden" name="shadowUser" value="<%=request.getParameter("shadowUser")%>" size="20" maxlength="32">
						<input type="hidden" name="shadowUserDomain" value="<%=request.getParameter("shadowUserDomain")%>" size="20" maxlength="32">
<%-- Password --%>
            <tr>
            ...
            <tr>
			  ...
			  <%
                    ...
                    if (request.isSecure()) {
                        ...
                        standardLink = "<a href=\"http://" + HttpUtils.getRequestURL(request).toString().substring(8) + "\">"+ PropertyProvider.get("prm.project.main.standard.label")
		                 + "</a>";
                    } else {
                        secureLink = "<a href=\"https://" + HttpUtils.getRequestURL(request).toString().substring(7) + "\">"
		                  + PropertyProvider.get("prm.project.main.secure.ssl.label") + "</a>";
...
<%-- Login Button --%>
            ...
            <tr>
              ...
              <td valign="top" bgcolor="D2E2F2">
			    ...
			    <% if (request.isSecure()) { %>
                      <img src="<%= SessionManager.getJSPRootURL() %>/images/icons/lock.gif" width="15" height="17" border="0"/>
                <% } %>
			  </td>
            </tr>
...
<%-- SUPPORT CHANNEL --%>
            ...
            <tr>
              <td height="40" align="left" bgcolor="C8D7E3" class="style1"><ul>
                <li class="style6"><display:get name="prm.global.login.helpdesk.1.text" /><a href="<%=SessionManager.getJSPRootURL()%>/help/HelpDesk.jsp"><display:get name="prm.global.login.helpdesk.2.link" /></a><display:get name="prm.global.login.helpdesk.3.text" /></li>
              </ul></td>
            </tr>
          </table></td>
        </tr>
