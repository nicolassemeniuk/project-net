...
<%@ page 
    ...
    import="net.project.admin.ApplicationMemberWizard,
...
<%
     ApplicationMemberWizard memberWizard = new ApplicationMemberWizard();
     ...
     pageContextManager.setProperty ("space.main.url", SessionManager.getJSPRootURL() + "/admin/Main.jsp");

	 pageContextManager.setProperty ("space.invite.acceptrequired.url", 
			SessionManager.getJSPRootURL() + 
			"/admin/ApplicationRegister.jsp" + 
