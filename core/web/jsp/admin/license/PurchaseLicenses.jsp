...
<jsp:forward page="/creditcard/CreditCardController.jsp">
    ...
    <jsp:param name="nextPage" value='<%=SessionManager.getJSPRootURL() + "/admin/license/LicensingTasks.jsp?module="+Module.APPLICATION_SPACE%>'/>
    <jsp:param name="previousPage" value='<%=SessionManager.getJSPRootURL() + "/admin/license/LicensingTasks.jsp?module="+Module.APPLICATION_SPACE%>'/>
    <jsp:param name="cancelPage" value='<%=SessionManager.getJSPRootURL() + "/admin/license/LicensingTasks.jsp?module="+Module.APPLICATION_SPACE%>'/>
