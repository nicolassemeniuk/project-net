...
<xsl:template match="person_list">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="tableHeader" align="left">
            ...
            <th class="tableHeader">Display Name</th>
            <th class="tableHeader">Email Address</th>
            <th class="tableHeader">User Status</th>
...
<xsl:template name="no_persons">
    <tr class="tableContent" align="left">
        <td class="tableContent" colspan="4">There are currently no persons associated with this license.</td>
    </tr>
</xsl:template>
