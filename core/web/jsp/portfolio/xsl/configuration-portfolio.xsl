...
<xsl:template match="configurationPortfolio">
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr class="tableHeader" align="left">
				...
				<th class="tableHeader"><xsl:value-of select="display:get('prm.personal.configuration.name.column')"/></th>
				<th class="tableHeader"><xsl:value-of select="display:get('prm.personal.configuration.description.column')"/></th>
			</tr>
			<tr class="tableLine">
...
<xsl:template name="no_configurations">
		<tr class="tableContent" align="left">
			<td class="tableContent" colspan="3"><xsl:value-of select="display:get('prm.personal.configuration.error.notaconfigurationmember.message')"/></td>
		</tr>
</xsl:template>
