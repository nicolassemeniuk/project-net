...
|     $Author: umesha $
|
| Popup window layout template
+----------------------------------------------------------------------*/
%>
<%@ page
    contentType="text/html; charset=UTF-8"
    info="Popup Window Layout Template"
    language="java"
...
<%------------------------------------------------------------------------------
	<body> Section
------------------------------------------------------------------------------%>
<body class="main" onload="trySetup();">
<% if (false) { // change condition to true to simply display the content - this allows the template to be used within the standard frames layout.%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<!-- Footer -->
		<td style="font-size: 12px" colspan="4" align="left" valign="bottom">
