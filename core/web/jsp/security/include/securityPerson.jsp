...
<%
	DisplayGroupList displayGroupListBean = securityManager.getPrincipalGroups();
...
<tr>
	<th>&nbsp;</th>
	<th align="left" class="tableHeader"><%=PropertyProvider.get("prm.security.editrole.people.name.column")%></th>
	<th align="left" class="tableHeader"><%=PropertyProvider.get("prm.security.editrole.people.description.column")%></th>
</tr>
<tr class="tableLine">
	...
	<jsp:setProperty name="displayGroupList" property="stylesheet" value="/security/include/securityGroup-people.xsl" />
