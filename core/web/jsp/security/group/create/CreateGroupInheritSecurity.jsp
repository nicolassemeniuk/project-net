...
<form method="post" name="main" action="<%=SessionManager.getJSPRootURL() + "/security/group/create/CreateGroupInheritSecurityProcessing.jsp"%>">
...
<tr class="channelHeader">
    ...
    <td nowrap class="channelHeader" colspan="2"><nobr><%=PropertyProvider.get("prm.directory.roles.groupcreate.inheritsecurity.permission.title")%></nobr></td>
...
<tr>
    ...
    <td colspan="2" class="tableHeader">
        <%=PropertyProvider.get("prm.directory.roles.groupcreate.inheritsecurity.instructions")%>
    </td>
    <td>&nbsp;</td>
</tr>
<%
    String permission = currentPage.getPermissionSelection();
    if (permission == null) {
        permission = "view";
    }
%>
<tr>
    ...
    <td class="tableContent">
        <input type="radio" name="permissionSelection" value="none" <%=(permission.equals("none") ? " selected" : "")%>/>&nbsp;<%=PropertyProvider.get("prm.directory.roles.groupcreate.roles.option.nopermissions.name")%>
...
<tr>
    ...
    <td>&nbsp;</td>
    <td class="tableContent">
        <input type="radio" name="permissionSelection" value="view" <%=(permission.equals("view") ? " selected" : "")%>/>&nbsp;<%=PropertyProvider.get("prm.directory.roles.groupcreate.roles.option.viewpermissions.name")%>
    </td>
    <td>&nbsp;</td>
</tr>
<tr>
    ...
    <td>&nbsp;</td>
    <td class="tableContent">
        <input type="radio" name="permissionSelection" value="default" <%=(permission.equals("default") ? " selected" : "")%>/>&nbsp;<%=PropertyProvider.get("prm.directory.roles.groupcreate.roles.option.defaultpermissions.name")%>
    </td>
    <td>&nbsp;</td>
</tr>
<tr><td colspan="4">&nbsp;</td></tr>
