...
<%@ page 
    ...
    info="include page for detailed view of a process" 
    language="java" 
...
<%
	String m_process_xml = m_process.getXML();
	XMLFormatter m_formatter = new XMLFormatter();
	m_formatter.setStylesheet("/process/include/processDetail.xsl");
	String m_output = m_formatter.getPresentation(m_process_xml);
	out.print(m_output);
%>
