...
/**
 * PnPagePermissionPK generated by hbm2java
 */
@Embeddable
public class PnPagePermissionPK implements Serializable {
    ...
    public PnPagePermissionPK(Integer spaceId, String page, Integer groupId) {
    ...
    @Column(name="PAGE", nullable=false, length=240)
