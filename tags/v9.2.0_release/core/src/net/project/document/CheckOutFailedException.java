...
public class CheckOutFailedException extends DocumentException {

    private final String NAME = "CheckOutFailedException";
    ...
    *****************************************************************************************************************/
    ...
    public CheckOutFailedException (String message, String severity) {
