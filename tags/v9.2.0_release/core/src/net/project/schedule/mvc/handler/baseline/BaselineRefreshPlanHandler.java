...
public class BaselineRefreshPlanHandler extends Handler {
    public BaselineRefreshPlanHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public String getViewName() {
        return "/servlet/ScheduleController/Baseline/Modify";
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        //Do the actual rebaselining task
        ...
        //Pass through parameters so we can return to our calling page
        passThru(model, "action");
        passThru(model, "module");
        model.put("baselineID", baselineID);
