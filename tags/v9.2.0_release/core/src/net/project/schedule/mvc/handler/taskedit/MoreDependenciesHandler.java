...
/**
 * This handler deals with what occurs when the user clicks on "More Dependencies"
 * link on the task edit page.
 *
 * @author Matthew Flower
 * @since Version 7.6
 */
public class MoreDependenciesHandler extends AbstractTaskEditProcessingHandler {
    /** The primary key of the schedule entry we are editing. */
    private String id;
     ...
     */
    public MoreDependenciesHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public void validateSecurity(int module, int action, String objectID,
        ...
        //No check necessary, it will occur on the taskedit redirect
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String extraDependenciesToShow = request.getParameter("moreDependencies");
        model.put("dependencies", extraDependenciesToShow);
