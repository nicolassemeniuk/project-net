 ...
 * @author 
 */
public class ShowActivityTextForFormData {
	...
	public void renderMessage() {
		try {
			objectToken = PropertyProvider.get("prm.project.activity.formdata");
			...
			Logger.getLogger(ShowActivityTextForFormData.class).error("Error occurred while setting description of form data activity("+ pnActivityLog.getActivityLogId() +"): "+e.getMessage());
		}
	}
}
