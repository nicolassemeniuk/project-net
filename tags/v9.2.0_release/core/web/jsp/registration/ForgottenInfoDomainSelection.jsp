...
| forgotten info process
|--------------------------------------------------------------------%>
<%@ page
    contentType="text/html; charset=UTF-8"
    info="Forgotten Info Domain Selection"
    language="java"
...
<%-- Available domains placed in reque3st by controller page --%>
...
<html>
<head>
<title><%=PropertyProvider.get("prm.registration.forgotteninfopage.title")%></title>
...
<script language="javascript">
    ...
    function validateForm(frm) {
        if (!checkRadio(frm.domainID, '<%=PropertyProvider.get("prm.registration.forgotteninfo.selectvalue.instruction")%>')) return false;
        return true;
    }
...
<table width="100%" cellpadding="1" cellspacing="0" border="0">
 	<tr>
 		...
 		<td align="right" class="regBanner"><%=PropertyProvider.get("prm.registration.forgotteninfo.pagetitle")%>&nbsp;</td>
 	</tr>
</table>
</div>
...
<form name="registration" action="<%=SessionManager.getJSPRootURL() + "/registration/ForgottenInfoDomainSelectionController.jsp"%>" method="post">
...
<table width="80%" cellpadding=0 cellspacing=0 border=0>
	...
	<tr class="actionBar">
		...
		<td colspan="2" valign="middle" class="actionBar"><%=PropertyProvider.get("prm.registration.forgotteninfo.channel.selectdomain.title")%></td>
	...
	<tr align="left">
        <td>&nbsp;</td>
        <td colspan="2">
            <%=PropertyProvider.get("prm.registration.forgotteninfo.selectdomain.instruction")%>
        </td>
        <td>&nbsp;</td>
    </tr>
	<tr align="left">
        ...
        <td colspan="2">
            ...
            <pnet-xml:transform name="availableDomains" scope="request" stylesheet="/registration/xsl/ForgottenInfoUserDomainSelect.xsl" />
        </td>
        <td>&nbsp;</td>
    </tr>
</table>
