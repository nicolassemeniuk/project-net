...
<xsl:template match="SummaryData">
    ...
    <tr>
        <td></td>    
        <td class="tableHeader" align="left" width="40%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.totalnumberoftasks.name')"/></td>
        <td class="tableContent" align="left" width="9%"><xsl:value-of select="TaskCount"/></td>
        <td class="chartCell" width="49%" align="center" rowspan="6"><img src="{ChartURL}"/></td>
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.totalnumberofcompletedtasks.name')"/></td>
        <td class="tableContent"><xsl:value-of select="CompletedTasks"/></td>
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.totalnumberofoverduetasks.name')"/></td>
        <td class="tableContent"><xsl:value-of select="OverdueTasks"/></td>
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.totalnumberofoverduemilestones.name')"/></td>
        <td class="tableContent"><xsl:value-of select="OverdueMilestones"/></td>        
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.taskscompletedinlast7days.name')"/></td>
        <td class="tableContent"><xsl:value-of select="TasksCompletedInLast7Days"/></td>        
        <td></td>    
    </tr>    
    <tr>
        <td></td>    
        <td class="tableHeader"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.tasksdueinnext7days.name')"/></td>
...
<xsl:template name="DetailedDataHeader">
    <tr class="channelHeader">
        <td class="channelHeader" width="1%"><img src="../images/icons/channelbar-left_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
        <td class="channelHeader"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.latetasks.title')"/></td>
        <td class="channelHeader" colspan="7"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
        <td class="channelHeader" align="right" width="1%"><img src="../images/icons/channelbar-right_end.gif" width="10" height="15" alt="" border="0" hspace="0" vspace="0"/></td>
    </tr>
    <tr>
        <td></td>    
        <td class="tableHeader" width="17%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.taskname.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.type.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.start.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.finish.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.workcomplete.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.totalwork.name')"/></td>
        <td class="tableHeader" width="8%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.complete.name')"/></td>
        <td class="tableHeader" width="17%"><xsl:value-of select="display:get('prm.schedule.report.latetaskreport.resources.name')"/></td>
        <td></td>    
    </tr>
    <tr>
        <td></td>    
