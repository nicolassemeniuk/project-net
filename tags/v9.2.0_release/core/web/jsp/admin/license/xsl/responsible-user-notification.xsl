...
Hello <xsl:value-of select="ResponsibleUser"/>,
	
You have been assigned the responsibility for the following license.
...
<xsl:template match="License">
  ...
  <!--  Internal ID: <xsl:value-of select="LicenseID" /> -->
    <xsl:choose>
...
<xsl:template match="LicenseModelCollection/TimeLimit">
    Create/Modify Date: <xsl:call-template name="Date">
...
<xsl:template match="LicenseModelCollection/NodeLocked">
    Node ID: <xsl:value-of select="NodeID/DisplayString" />
</xsl:template>
