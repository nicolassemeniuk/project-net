...
<%
     BusinessMemberWizard memberWizard = new BusinessMemberWizard();
     ...
     pageContextManager.setProperty ("space.main.url", SessionManager.getJSPRootURL() + "/business/Main.jsp");
	 pageContextManager.setProperty ("space.invite.acceptrequired.url", 
			SessionManager.getJSPRootURL() + 
			"/business/BusinessRegister.jsp" + 
			"?businessid=" + request.getParameter("id") +
