...
<table border="0" cellspacing="0" cellpadding="0" width="100%" name="tableWithEvenRowsWOH">
	...
	<tr class="tableContent" align="left"> 
		<td class="tableContent" align="left">
			...
			<div style="text-align:right">
				...
				<xsl:value-of select="display:get('prm.news.newschannel.postedby.message' , string(posted_by_full_name) , $dateTime) "/>
			</div>
		</td>
	</tr>
</xsl:template>
...
<tr class="tableContent" align="left"> 
  <td class="tableContent" colspan="5">
	<a href="{jsp_root_url}/news/NewsEdit.jsp?action=4&amp;module=110&amp;mode=create"><xsl:value-of select="display:get('prm.business.dashboard.createnews.link')"/></a>
  </td>
</tr>
</xsl:template>
