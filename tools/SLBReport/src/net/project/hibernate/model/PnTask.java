...
public class PnTask implements Serializable {
    ...
    /** nullable persistent field */
    private BigDecimal unassignedWorkUnits;
    ...
    /** persistent field */
    private Set pnTaskBaselines;

    /** full constructor */
    public PnTask(BigDecimal taskId, String taskName, String taskDesc, String taskType, BigDecimal duration, BigDecimal work, BigDecimal workUnits, BigDecimal workComplete, Date dateStart, BigDecimal workCompleteUnits, Date dateFinish, Date actualStart, Date actualFinish, Integer priority, Integer percentComplete, Date dateCreated, Date dateModified, BigDecimal modifiedBy, BigDecimal durationUnits, BigDecimal parentTaskId, String recordStatus, BigDecimal criticalPath, BigDecimal seq, Integer ignoreTimesForDates, Integer isMilestone, Date earlyStart, Date earlyFinish, Date lateStart, Date lateFinish, BigDecimal workPercentComplete, BigDecimal calculationTypeId, BigDecimal unallocatedWorkComplete, BigDecimal unallocatedWorkCompleteUnit, String constraintType, Date constraintDate, Date deadline, BigDecimal workMs, BigDecimal workCompleteMs, BigDecimal unassignedWork, BigDecimal unassignedWorkUnits, net.project.hibernate.model.PnObject pnObject, Set pnPlanHasTasks, Set pnPhaseHasTasks, Set pnTaskHistories, Set pnTaskBaselines) {
        this.taskId = taskId;
    ...
    /** minimal constructor */
    public PnTask(BigDecimal taskId, String taskName, String recordStatus, Set pnPlanHasTasks, Set pnPhaseHasTasks, Set pnTaskHistories, Set pnTaskBaselines) {
        this.taskId = taskId;
        this.taskName = taskName;
        this.recordStatus = recordStatus;
        this.pnPlanHasTasks = pnPlanHasTasks;
    ...
    public BigDecimal getUnassignedWorkUnits() {
        return this.unassignedWorkUnits;
    }

    public void setUnassignedWorkUnits(BigDecimal unassignedWorkUnits) {
        this.unassignedWorkUnits = unassignedWorkUnits;
    }
