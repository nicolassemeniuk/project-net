...
/
create index DOCUMENT_IDX2 on PN_DOCUMENT (DOC_STATUS_ID)
/
create index DOCUMENT_IDX3 on PN_DOCUMENT (DOC_TYPE_ID) TABLESPACE INDEX01
/
create index DOCUMENT_IDX4 on PN_DOCUMENT (RECORD_STATUS) TABLESPACE INDEX01
/
...
alter table PN_DOC_CONTAINER
  ...
  check (record_status in ('A','P','D','H'))
/
create index DOC_CONTAINER_BIDX1 on PN_DOC_CONTAINER (IS_HIDDEN)
/
