...
function finish() {
	if (<%=isOwnedProjects%>) {
		var theLocation=JSPRootURL+"/servlet/AllTasksExportXml?module=<%=Module.SCHEDULE%>&action=<%=Action.MODIFY%>&selected=" + self.document.forms[0].selected.value;
...
<table width="97%" cellspacing="0" cellpadding="0" vspace="0"  border="0">
    ...
    <tr>
		<td width="1%"></td>
		<td class="tableContent"><label>
			<display:get name="prm.schedule.export.csv.main.message" />
			</label></td>
	</td>
</tr>
<tr>
