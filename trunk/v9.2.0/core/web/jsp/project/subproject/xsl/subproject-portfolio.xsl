  ...
  <xsl:template match="ProjectPortfolio">
  	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr class="tableHeader" align="left" valign="top">
            ...
            <td class="tableHeader"><xsl:value-of select="display:get('prm.project.subprojectportfolio.startdate.label')" /></td>
            <td class="tableHeader"><xsl:value-of select="display:get('prm.project.subprojectportfolio.enddate.label')" /></td>
			<td class="tableHeader"><xsl:value-of select="display:get('prm.project.subprojectportfolio.status.label')"/></td>
            <!-- Overall Status -->
	...
	<xsl:template match="ProjectSpace">
		<tr align="left" valign="middle" class="tableContent">
			...
			<td class="tableContent">
				<xsl:element name="a">
					<xsl:attribute name="class">subproject</xsl:attribute>
            ...
            <td class="tableContent"><xsl:value-of select="format:formatISODate(EndDate)" /></td>
