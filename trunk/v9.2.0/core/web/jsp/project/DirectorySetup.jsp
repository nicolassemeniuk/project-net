...
<%@ page
    ...
    import="net.project.project.ProjectMemberWizard,
...
<%
     ProjectMemberWizard memberWizard = new ProjectMemberWizard();
     ...
     pageContextManager.setProperty ("space.main.url", SessionManager.getJSPRootURL() + "/project/Dashboard");
	 pageContextManager.setProperty ("space.invite.acceptrequired.url", 
			SessionManager.getJSPRootURL() + 
			"/project/ProjectRegister.jsp" + 
