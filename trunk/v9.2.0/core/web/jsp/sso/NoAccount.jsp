...
<h2>
<display:get name="prm.global.login.sso.NoUserDefinedMessage" />
<br/></br>
<%
	if (request.getAttribute("SaSecurityError") != null) {
		out.println( "or " + request.getAttribute("SaSecurityError"));
	}
%>
</h2>
	</td>
