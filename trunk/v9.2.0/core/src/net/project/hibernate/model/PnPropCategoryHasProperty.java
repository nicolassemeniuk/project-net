...
/**
 * PnPropCategoryHasProperty generated by hbm2java
 */
@Entity
@Table(name="PN_PROP_CATEGORY_HAS_PROPERTY"
)
public class PnPropCategoryHasProperty implements Serializable {


     private PnPropCategoryHasPropertyPK comp_id;

    public PnPropCategoryHasProperty() {
    }

    public PnPropCategoryHasProperty(PnPropCategoryHasPropertyPK comp_id) {
    ...
    public PnPropCategoryHasPropertyPK getComp_id() {
        return this.comp_id;
    }
    
    public void setComp_id(PnPropCategoryHasPropertyPK comp_id) {
        this.comp_id = comp_id;
    }
