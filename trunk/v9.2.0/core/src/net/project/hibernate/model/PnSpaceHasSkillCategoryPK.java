...
/**
 * PnSpaceHasSkillCategoryPK generated by hbm2java
 */
@Embeddable
public class PnSpaceHasSkillCategoryPK implements Serializable {
    ...
    public PnSpaceHasSkillCategoryPK(Integer spaceId, Integer skillCategoryId) {
    ...
    @Column(name="SKILL_CATEGORY_ID", nullable=false, length=20)
