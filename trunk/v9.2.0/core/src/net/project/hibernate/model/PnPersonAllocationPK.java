...
/**
 * PnPersonAllocationPK generated by hbm2java
 */
@Embeddable
public class PnPersonAllocationPK implements Serializable {
    ...
    public PnPersonAllocationPK(Integer spaceId, Integer personId, Integer allocationId) {
    ...
    @Column(name="ALLOCATION_ID", nullable=false, length=20)
