...
/**
 * Set (or replace) the phase that one or more items in the schedule is
 * associated with.
 *
 * @author Matthew Flower
 * @since Version 7.6.3
 */
public class SetPhaseHandler extends MultiItemHandler {
    public SetPhaseHandler(HttpServletRequest request) {
        super(request);
    }
    ...
    public Map handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        TaskListUtils.setPhase(idList, request.getParameter("phaseID"));
