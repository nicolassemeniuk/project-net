...
public class DomainListAttribute extends AbstractAttribute {
     ...
     * @since Gecko
     */
    public DomainListAttribute(String id, String displayName) {
     ...
     * @since Gecko
     */
    public DomainListAttribute(String id, String displayName, boolean required) {
        super(id, displayName, required);
    }


    public DomainListAttribute(String id, String displayName, DomainValues domainValues) {
        super(id, displayName);
