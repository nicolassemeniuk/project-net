...
|     $Author: umesha $
|
| WorkflowList is a simple subclass of ArrayList which provides XML
| facilities.
+----------------------------------------------------------------------*/
...
/**
 * WorkflowList provides XML facilities for an ArrayList of
 * Workflows
 */
public class WorkflowList extends ArrayList
    implements IXMLPersistence, java.io.Serializable {

    /**
     * Returns the individual Workflow elements
    ...
    private String getXMLElements() {
        ...
        for (int i = 0; i < size(); i++) {
            xml.append(((Workflow)get(i)).getXMLBody());
        }
        return xml.toString();
    }
    ...
    /**
     * Return the WorkflowList XML including the XML version tag
    ...
    /**
     * Return the WorkflowList XML without the XML version tag
     * @return XML string
     */
