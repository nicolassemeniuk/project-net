...
(
  ...
  HIDDEN_FOR_EAF     NUMBER(1,0) DEFAULT 0
)
;
...
(
  ...
  RECORD_STATUS        VARCHAR2(1) not null,
  CRC                  DATE,
  IS_CREATE_TYPE VARCHAR2(1) DEFAULT 0
)
;
...
(
  ...
  PERSON_ID       NUMBER(20) not null,
  ANCHOR          VARCHAR2(240) null,
  TITLE           VARCHAR2(240) null,
  TEXT            CLOB not null,
  PUB_TIME        DATE,
...
CREATE INDEX WEBLOG_COMMENT_IDX3 ON PN_WEBLOG_COMMENT (PERSON_ID);
...
CREATE INDEX WIKI_CREATED_BY ON PN_WIKI_PAGE (CREATED_BY) TABLESPACE INDEX01;
